    ...
    \section{Resultados}
        ...
        \subsection{Nro. de visitas por unidad de tiempo}
            ...
            \begin{frame}{Nro. de visitas por unidad de tiempo}{Animación}
                \begin{minipage}[t]{0.60\textwidth}
                    \begin{figure}[H!]
                        ...
                        \caption*{Véase la animación completa en \url{https://youtu.be/TXe88VVMnL4}.}
                        \label{fig:obc_1}
                    \end{figure}
                \end{minipage}
                \hfill
            ...
            \begin{frame}{Nro. de visitas por unidad de tiempo}{Cantidad total de visitas en función del tiempo}
                \begin{figure}[H!]
                    \includegraphics[width=0.9\textwidth]{./visits_vs_time_obc-n300-eta0p6}
                    \label{fig:obc_2}
                \end{figure}
                \begin{beamercolorbox}[sep=5pt,center]{block body}
                    \begin{minipage}[t]{0.3\textwidth}
    ...
    \section{Conclusiones}
        ...
        \begin{frame}{Conclusiones}
            \begin{itemize}
                ...
                \end{itemize}
                \item En las visitas OBC se puede contemplar que la cantidad de visitas por unidad de tiempo se mantiene
                constante a medida que el ruido aumenta, sin importar el $N$.
            \end{itemize}
        \end{frame}
